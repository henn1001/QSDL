...
public class TestUtils {
    ...
    private static <T extends AbstractEntity> InstancioApi<T> instanceIoIgnoreIds(Class<T> cls) {
        return instanceIo(cls)
                .ignore(field(AbstractEntity::getId))
                .ignore(field(AbstractEntity::getUid))
    ...
    public static <T extends AbstractEntity> T getRandomEntityWithNullId(Class<T> cls) {
        return instanceIoIgnoreIds(cls).create();
    }

    public static <T extends AbstractEntity> List<T> getRandomEntityWithNullId(Class<T> cls, int count) {
    ...
    public static void copyAllIdentities(Object a, Object b) throws Exception {
        ...
        for (Field field : a.getClass().getDeclaredFields()) {
            ...
            else if (field.get(a) instanceof AbstractEntity) {
