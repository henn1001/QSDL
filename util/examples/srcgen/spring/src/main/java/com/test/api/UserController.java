...
public class UserController {
  ...
  public ResponseEntity<UserList> getUsersForTicket(@PathVariable("ticket_id") Long ticketId, ApiPageable pageable) throws Exception {
    UserList response = UserService.getUsersForTicket(ticketId, pageable);
  ...
  public ResponseEntity<UserList> getUsers(ApiPageable pageable) throws Exception {
    UserList response = UserService.getUsers(pageable);
    return new ResponseEntity<>(response, HttpStatus.OK);
  }
